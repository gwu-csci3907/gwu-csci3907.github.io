...
- **Step 3**: [Install VS Code for Mac](vscode-mac.qmd) [Optional]

- **Step 4**: [Install Anaconda for Mac](anaconda-mac.qmd) [Optional]
...
Once you've finished **installation Steps 0 and 1**, fill out the [Installation Check-In form](https://forms.gle/Y6Yi9HTZSjD1MPHb7) and the [CS1010 Entry form](https://forms.gle/EoKoGY5KHMi4wEBs7). Both the forms are **MANDATORY** to be filled out before the first class.
