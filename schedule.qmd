...
<tr class="table-secondary">
      ...
      <td>
        <ul>
          <li>Guest lecture:  **Empowering IoT and Edge Computing with Design Thinking** by <a href="/Lectures_Speakers/Nuzum-bio-Feb2024.pdf"
...
<tr class="table-primary">
      <th scope="row">03/08/2024</th>
      <td colspan="2" style="text-align: center">Midterm Project Presentations. Midterm Project Report and Live Demos due.</td> 
      <!--- <td>Column content</td> -->
    </tr>
<tr class="table-primary">
