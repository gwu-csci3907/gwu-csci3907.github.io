...
<tr class="table-primary">
      ...
      <td colspan="2" style="text-align: center">Midterm Project Presentations and Live Demos due.</td> 
      <!--- <td>Column content</td> -->
    </tr>
<tr class="table-primary">
      <th scope="row"> [03/11/2024]</th>
      <td colspan="2" style="text-align: center">Midterm Project Report due.</td> 
      <!--- <td>Column content</td> -->
    </tr>
<tr class="table-primary">
